...
もともと `.typ` や `.md` でアクセスしたときの Content-Type ヘッダは #link("https://www.iana.org/assignments/media-types/media-types.xhtml")[IANA Media Types]に基づき、、#ghlink("/911bc977a8a5cd00c2543ab55cc0b85823d83196/src/app.rs#L254")[`text/vnd.typst; charset=utf-8` や `text/markdown; charset=utf-8`] となっていました。
